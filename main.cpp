...
int main() {
    DataSet classificationTrainingSet("./src/datasets/classification_data.csv",
                                      "./src/datasets/classification_labels.csv", "classification");
    DataSet regressionTrainingSet("./src/datasets/regression_data.csv",
                                  "./src/datasets/regression_labels.csv", "regression");
    ...
    DataSet trainingSet2("./src/datasets/classification_data.csv",
                         "./src/datasets/classification_labels.csv", "classification");
